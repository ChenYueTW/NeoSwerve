...
public class SwerveModule {
    ...
    public SwerveModule(
        ...
        this.turnEncoder.configMagnetOffset(turnEncoderOffset);

        this.turnPidController = new PIDController(0.1, 0, 0);
    ...
    public void setEncoderDashboard() {
        ...
        SmartDashboard.putNumber(this.motorName + " TurnPosition", this.turnEncoder.getAbsolutePosition());
